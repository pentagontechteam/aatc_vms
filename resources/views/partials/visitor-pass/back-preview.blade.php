<div
    class="mx-auto bg-white w-80 h-[500px] shadow-xl flex overflow-hidden relative pass-body">
    <!-- Corner Decorations -->
    ...
    <div class="flex-1 p-4 relative flex flex-col">
        ...
        <div class="flex items-center justify-center mb-6">
            <img
                src="{{ asset('assets/Picture2.jpeg') }}"
                alt="Top Logo"
        ...
        <div class="p-4 flex-1 flex flex-col z-20 pt-[2.5rem] items-center">
            <!-- Decorative element -->
            <div
                class="w-3/4 h-1 bg-gradient-to-r from-transparent via-[#0d9488] to-transparent mb-6 rounded-full"></div>
            ...
            <div class="text-center">
                <div class="text-base font-medium text-gray-800">
                    If found please return to Afreximbank African Trade Center
                    Abuja.
                </div>
            </div>
            ...
            <!-- Decorative element -->
            <div
                class="w-3/4 h-1 bg-gradient-to-r from-transparent via-[#0d9488] to-transparent mt-6 rounded-full"></div>
        </div>

        <!-- Fixed Bottom-Right Logo -->
        <div class="absolute bottom-0 right-0 z-10">
            <img
                src="{{ asset('assets/Picture-nobg.png') }}"
                alt="Bottom Logo"
                class="h-[10rem] opacity-40" />
        </div>
